...
def two_lines_intersecting(line1, line2):
    intersect = False
    if (((line1[0][0] == line1[1][0]) and (line1[0][1] == line1[1][1])) or (
            (line2[0][0] == line2[1][0]) and (line2[0][1] == line2[1][1]))):
        intersect = False
    else:
        ...
        check_val = False
        if (((m1 != np.inf) and (m1 != -np.inf)) and
                ((m2 != np.inf) and (m2 != -np.inf))):
            check_val = True
            if (m1 - m2) != 0:
        ...
        if ((np.abs(m1 - m2) > 1e-6) and (check_val)):
            ...
            if (line1[0, 0] == line2[0, 0] and line1[0, 1] == line2[0, 1]) or (line1[0, 0] == line2[1, 0] and line1[0, 1] == line2[1, 1]) or (
                    line1[1, 0] == line2[0, 0] and line1[1, 1] == line2[0, 1]) or (line1[1, 0] == line2[1, 0] and line1[1, 1] == line2[1, 1]):
                intersect = False
        ...
        if (((m1 == np.inf) or (m1 == -np.inf)) or
                 ((m2 == np.inf) or (m2 == -np.inf))):
            if (((m1 != np.inf) and (m1 != -np.inf)) or
                     ((m2 != np.inf) and (m2 != -np.inf))):
                if ((m1 != 0) and (m2 != 0)):
                    line3 = np.zeros((2, 2))
                    line4 = np.zeros((2, 2))
                    ...
                    line4[1, 0] = line2[1, 1]
                    line4[1, 1] = line2[1, 0]
                    m3 = (line3[1, 1] - line3[0, 1]) / \
                        (line3[1, 0] - line3[0, 0])
                    m4 = (line4[1, 1] - line4[0, 1]) / \
                        (line4[1, 0] - line4[0, 0])
                    ...
                    if (m1 == 0):
                        ...
                        if ((y1 > y2min) and (y1 < y2max) and (
                                x2 > x1min) and (x2 < x1max)):
                            intersect = True
                    ...
                    if (m2 == 0):
                        ...
                        if ((y2 > y1min) and (y2 < y1max) and (
                                x1 > x2min) and (x1 < x2max)):
                            intersect = True
...
if __name__ == '__main__':
    # The first column represents to x-values of the line segment line[0,0] y
    # line[1,0]. The second column represents the y-values of
